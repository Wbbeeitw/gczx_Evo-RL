...
from .model_utils import auto_cast
...
class XR0(nn.Module):
    ...
    def __init__(
        ...
        self.qwen_attn_implementation = qwen_attn_implementation
    ...
    def _build_model(self) -> None:
        ...
        self.vlm = Qwen3VLForConditionalGeneration.from_pretrained(
            self.qwen_variant,
            attn_implementation=self.qwen_attn_implementation,
        ...
        self.rotary_emb = Qwen3VLTextRotaryEmbedding(Qwen3VLTextConfig.from_pretrained(self.qwen_variant))
    ...
    def forward(self, batch: Dict[str, Any], return_loss: bool = False) -> Dict[str, torch.Tensor]:
        ...
        # Keep robot tensors out of Qwen's kwargs. The official training stack
        # tolerated extra keys, but LeRobot may run with different Transformers
        # versions where unknown kwargs are stricter.
